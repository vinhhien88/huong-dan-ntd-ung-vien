...
export const MODULES: GuideModule[] = [
  ...
  },
  {
    ...
    imageSteps: [
      { stepNumber: 1, title: "Truy cập trang đăng ký NTD", description: "Mở trang HR1Jobs và chọn khu vực dành cho Nhà tuyển dụng.", imageUrl: placeholder, caption: "Ảnh bước 1: Truy cập trang đăng ký NTD" },
      { stepNumber: 2, title: "Nhập thông tin doanh nghiệp", description: "Điền tên công ty, mã số thuế, người phụ trách tuyển dụng.", imageUrl: placeholder, caption: "Ảnh bước 2: Nhập thông tin doanh nghiệp" },
      { stepNumber: 3, title: "Xác nhận email / số điện thoại", description: "Hệ thống có thể yêu cầu xác minh để bảo mật tài khoản.", imageUrl: placeholder, caption: "Ảnh bước 3: Xác nhận email / số điện thoại" },
      { stepNumber: 4, title: "Vào trang quản trị NTD", description: "Tài khoản được tạo và chuyển đến dashboard quản lý.", imageUrl: placeholder, caption: "Ảnh bước 4: Vào trang quản trị NTD" },
    ],
  ...
  },
  {
    ...
    imageSteps: [
      { stepNumber: 1, title: "Mở trang đăng nhập NTD", description: "Vào HR1Jobs và chọn đăng nhập dành cho Nhà tuyển dụng.", imageUrl: placeholder, caption: "Ảnh bước 1: Mở trang đăng nhập NTD" },
      { stepNumber: 2, title: "Nhập thông tin đăng nhập", description: "Điền email/SĐT đã đăng ký và mật khẩu.", imageUrl: placeholder, caption: "Ảnh bước 2: Nhập thông tin đăng nhập" },
      { stepNumber: 3, title: "Kiểm tra & xác nhận", description: "Đảm bảo thông tin chính xác trước khi đăng nhập.", imageUrl: placeholder, caption: "Ảnh bước 3: Kiểm tra & xác nhận" },
      { stepNumber: 4, title: "Vào dashboard NTD", description: "Bắt đầu sử dụng các tính năng quản lý tuyển dụng.", imageUrl: placeholder, caption: "Ảnh bước 4: Vào dashboard NTD" },
    ],
  },
  {
    ...
    imageSteps: stepsFromChecklist([
      ...
      { title: "Chọn phương thức thanh toán", description: "Hỗ trợ chuyển khoản ngân hàng, thẻ tín dụng/ghi nợ và ví điện tử." },
  ...
  },
  {
    ...
    checklist: [
      "Vào khu vực đăng tuyển.",
      "Nhập thông tin vị trí tuyển dụng.",
      "Điền mô tả công việc, yêu cầu, quyền lợi, địa điểm và mức lương.",
      "Kiểm tra lại nội dung tin đăng.",
      "Gửi duyệt hoặc đăng tin.",
    ],
    imageSteps: stepsFromChecklist([
      { title: "Vào khu vực đăng tuyển", description: "Chọn mục đăng tin tuyển dụng trên dashboard." },
      { title: "Nhập thông tin vị trí", description: "Tên vị trí, ngành nghề, cấp bậc, hình thức làm việc." },
      { title: "Mô tả công việc & quyền lợi", description: "Điền JD chi tiết, yêu cầu ứng viên và phúc lợi." },
      { title: "Kiểm tra nội dung", description: "Xem trước tin đăng để đảm bảo nội dung chính xác." },
      { title: "Gửi duyệt / đăng tin", description: "Hoàn tất quy trình và chờ hệ thống duyệt nếu có." },
    ]),
  ...
  },
  {
    ...
    checklist: [
      "Vào mục quản lý tin tuyển dụng.",
      "Chọn tin tuyển dụng cần xem ứng viên.",
      "Mở danh sách hồ sơ ứng tuyển.",
      "Xem chi tiết hồ sơ và thông tin liên hệ nếu có.",
      "Lưu, tải hoặc chuyển trạng thái ứng viên nếu hệ thống hỗ trợ.",
    ],
    imageSteps: stepsFromChecklist([
      { title: "Quản lý tin tuyển dụng", description: "Truy cập danh sách các tin đăng đang chạy." },
      { title: "Chọn tin cần xem ứng viên", description: "Click vào tin tuyển dụng cụ thể." },
      { title: "Danh sách hồ sơ ứng tuyển", description: "Xem tổng quan các ứng viên đã nộp." },
      { title: "Xem chi tiết hồ sơ", description: "Mở từng hồ sơ để xem thông tin chi tiết." },
  ...
  },
  {
    ...
    imageSteps: stepsFromChecklist([
      ...
      { title: "Cập nhật thông tin công ty", description: "Tên, lĩnh vực, quy mô, địa chỉ, logo." },
      { title: "Cập nhật người liên hệ", description: "Tên, chức danh, email, số điện thoại liên hệ." },
  ...
  },
  {
    ...
    checklist: [
      ...
      "Xác nhận email hoặc số điện thoại nếu có yêu cầu.",
    ...
    imageSteps: stepsFromChecklist([
      ...
      { title: "Xác nhận tài khoản", description: "Kiểm tra email hoặc SMS để xác minh tài khoản." },
  ...
  },
  {
    ...
    checklist: [
      ...
      "Nhập mật khẩu.",
      "Đăng nhập và vào trang cá nhân.",
    ],
    imageSteps: stepsFromChecklist([
      { title: "Mở trang đăng nhập", description: "Vào HR1Jobs và chọn Đăng nhập dành cho Ứng viên." },
      { title: "Nhập thông tin đăng nhập", description: "Điền email/SĐT đã đăng ký và mật khẩu." },
      { title: "Xác nhận và đăng nhập", description: "Kiểm tra lại thông tin trước khi nhấn Đăng nhập." },
